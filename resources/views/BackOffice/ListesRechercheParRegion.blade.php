...
<div id="chartdiv"></div> 
                    ...
                    <div class="col-sm-5.75" style="margin-left:660px;margin-top:-532px">
                        <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <code style="font-size:18px"></code>
                           <h3 class="box-title">Nombres des candidats par region qui ont postulés sur {{ $nomOffre }}</h3>
                                <style>
                                    #candidatParRegion {
                                         width: 96%;
                                        height: 400px;
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <code style="font-size:18px"></code>
                            <h3 class="box-title" style="color: #286ac7">Listes des agents enquêteurs qui ont postulés sur {{ $nomOffre }}</h3>
                            <form  method="post" action="{{ route('ExportExcelEnqueteurs') }}">
                             @csrf
                            <input type="hidden" name="idOffre" value="<?php echo $idoffres; ?>">
                            <button type="submit" class="btn btn-success" style="margin-left:1000px;margin-top: -65px;color:white">Export en Excel <i class="fas fa-download" aria-hidden="true" style="margin-left: 5px"></i></button>
                            </form>

                            
                            <form method="get" action="FiltreParRegion">
                                  @csrf
                            <div class="input-group mb-3" style="width:700px">
                                <input type="hidden" name="idoffre" value="<?php echo $idoffres; ?>">
                                <input type="hidden" name="nomchamps" value="<?php echo $nomchamps; ?>">
                                 <h5 style="margin-top:5px">Filtre:</h5><select name="nomRegion" class="form-control" style="margin-left:6px"> 
                                  <option value=""></option>
                                ...
                                <select name="typeEnqueteur" class="form-control" style="margin-left:20px"> 
                                    <option value=""></option> 
                                    @foreach($types as $ty) 
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('DetailsEnqueteur/'.$ListesEnqueteurs[$l][$j]->valeur) }}" style="width:150px;height:150px"></td>
                                 ...
                                 <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-end">
                                      ...
                                      <li class="page-item active"><a class="page-link" href="FiltreParRegion?idoffre=<?php echo $idoffres; ?>&&Page=<?php echo $i ?>&&nomRegion=<?php echo $_GET['nomRegion']; ?>&&nomchamps=<?php echo $_GET['nomchamps']; ?>"><?php echo $i ?></a></li>
                                        <?php } else { ?>
                                         <li class="page-item"><a class="page-link" href="FiltreParRegion?idoffre=<?php echo $idoffres; ?>&&Page=<?php echo $i ?>&&nomRegion=<?php echo $_GET['nomRegion']; ?>&&nomchamps=<?php echo $_GET['nomchamps']; ?>"><?php echo $i ?></a></li>
                                         <?php } } ?>
                                      <li class="page-item">
